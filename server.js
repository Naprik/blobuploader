...
var blobClient = azure.createBlobService('DefaultEndpointsProtocol=https;AccountName=beeh1vefilestorage;AccountKey=r/EggteHjpIW9FxEhWaQ00iWjaK1bClfUIHbhWap6cV5RtvV7R0INFV719H3qgovdcj1Hse5o/YWayVLqCsU2Q==;').withFilter(new azure.ExponentialRetryPolicyFilter());
...
app.get('/Display', function (req, res) {
    blobClient.listBlobsSegmented(containerName, null, function (error, blobs) {
